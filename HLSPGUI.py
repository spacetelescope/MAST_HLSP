...
#from PREP_CAOM.hlsp_to_xml import hlsp_to_xml
...
class HLSPGUI(QTabWidget):
    ...
    def __init__(self):
        ...
        load_hlsp = GreyButton(
            "Load an .hlsp File", 40, min_width=150)

        # Set up the tabs contained in this widget
        self.tabs = QTabWidget()
        self.step1 = CheckFilenamesGUI(parent=self)
        #self.step2 = select_data_templates_gui.SelectDataTemplatesGUI()
        ...
        self.meta_grid.addWidget(path_label, 0, 0)
        self.meta_grid.addWidget(self.hlsp_path_edit, 0, 1)
        self.meta_grid.addWidget(load_hlsp, 0, 2)
        self.meta_grid.addWidget(self.tabs, 1, 0, 1, -1)

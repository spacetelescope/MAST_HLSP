This folder contains Python software used for 1) checking that file names follow MAST HLSP convention, 2) change the file name to lowercase, and change the signs ('+/-') in file names to 'p/m'.
